classdef FuzzySeguirParede < simiam.controller.Controller
...
% see the LICENSE file included with this software
    ...
    methods
        ...
        function obj = FuzzySeguirParede()
            obj = obj@simiam.controller.Controller('fuzzy_seguir_parede');            
        ...
        function outputs = execute(obj, robot, state_estimate, inputs, dt)
            ...
            SP_CompY = SP_CompensaDistanciaY + velSP*2*SP_Y;
            difX = EO_VetX + SP_CompX;
            difY = EO_VetY + SP_CompY;
            ...
            Input_SV = [difX difY v];
            EO = [EO_VetX EO_VetY]
            SP = [SP_CompX SP_CompY SP_CompensaDistanciaY]
