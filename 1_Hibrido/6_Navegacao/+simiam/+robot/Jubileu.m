...
%            obj.add_surface_with_alpha(qb_axle, [0.15 0.15 0.15], 0.5);
            ...
            obj.vel_linear_min = obj.wheel_radius*obj.min_vel; % == 0.21363708953606095 m/s
            obj.vel_linear_max = obj.wheel_radius*obj.max_vel; % == 0.593063493182867 m/s
        ...
        function ir_distances = get_ir_distances(obj)
            ...
            ir_distances = polyval(coeff, ir_voltages)/100;
        end
...
%                 fprintf('%0.3f, %0.3f\n', distances(i), voltages(i));
            ...
            % (rampa com saturação superior e inferior)
        end
    end
end