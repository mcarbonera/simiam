...
% see the LICENSE file included with this software
    ...
    methods
        ...
        function obj = AppWindow(root, origin)
            ...
            obj.ui_size_ = [0 0 1920 990];
            
            obj.is_tracking_ = false;
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            obj.center_ = simiam.ui.Pose2D(0,0.05,0);
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        function create_layout(obj)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % Alteração: Maximizar a tela
            % Digitar atalho do teclado: 
            % 1) alt+espaço
            % 2) x
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            pause(0.05);
            maxim = java.awt.Robot; 
            maxim.keyPress(java.awt.event.KeyEvent.VK_ALT);      %// send ALT
            maxim.keyPress(java.awt.event.KeyEvent.VK_SPACE);    %// send SPACE
            maxim.keyRelease(java.awt.event.KeyEvent.VK_SPACE);  %// release SPACE
            maxim.keyRelease(java.awt.event.KeyEvent.VK_ALT);    %// release ALT
            maxim.keyPress(java.awt.event.KeyEvent.VK_X);        %// send X
            maxim.keyRelease(java.awt.event.KeyEvent.VK_X);      %// release X
            ...
            %set(obj.parent_, 'units', 'normalized', 'outerposition', [0 0 1 1]);
        ...
        function ui_button_start(obj, src, event)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % Mudar Escala: 
            obj.zoom_level_ = obj.zoom_level_*1.8;
            obj.boundary_ = obj.boundary_*1.8;
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%           obj.create_simulator(fullfile(pathname, filename));
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % Colocar zoom_out onde eu quero (visão panorâmica)
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            % Necessário após mudança de escala.
            obj.ui_zoom_view(src, event);
            obj.ui_zoom_view(src, event);
            obj.ui_zoom_view(src, event);
            obj.ui_zoom_view(src, event);
